...
Hicimos una app que sirve para calcular descuentos. Pero no un solo descuento, sino "descuentos encadenados", cuando le aplicas un descuento a un precio, y al resultado que te da le bajas otro porcentaje mas, y asi.
...
- Se trabajo con ramas individuales por cada integrante.
...
Ademas de las que vamos a explicar abajo, en nuestro codigo tambien usamos estas funciones para que funcione todo:
...
- **Linea 1:** Creamos una funcion que la nombramos `fmt`, de formato, que espera recibir algo que llamamos `n`. En nuestro caso, ese valor representa un monto de dinero.
...
Una vez dentro de la carpeta, se abre el archivo `index.html` con cualquier navegador web.
